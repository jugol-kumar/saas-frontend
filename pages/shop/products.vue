    ...
    <div class="col-lg-6">
      <div class="th-list glass-morphi-border bg-glass-morphi p-3 rounded mb-3">
        <NuxtLink to="" class="th-list-left w-30">
          <img src="/images/product.png" class="w-100 h-100" alt="">
        </NuxtLink>
        <div class="th-list-right w-65">
          <div class="th-list-right-text">
            <div class="d-flex align-items-center justify-content-between">
              <h4>
                <NuxtLink to="/shop/product-detail">Apple Watch</NuxtLink>
              </h4>
            ...
            <div class="mt-3">
              <p class="d-flex aling-items-center gap-2">PRICE:<span class="fw-bold">$58</span></p>
              <p  class="d-flex aling-items-center  gap-2">Created:<span class="fw-bold">Aug 18, 2022</span></p>
            </div>
