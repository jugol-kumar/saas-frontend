  ...
  <div class="app-content content mt-5">
    ...
    <div class="content-wrapper container-xxl p-0">
      ...
      <div class="content-body">
            ...
            <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
              ...
              <div class="card bg-glass-morphi glass-morphi-border">
                <div class="card-body d-flex flex-column gap-3">
                  ...
                  <button class="primary-button w-100" data-bs-toggle="modal" data-bs-target="#add-payment-sidebar">
                    Add Payment
                  </button>
                </div>
              </div>
        ...
        <div class="modal modal-slide-in fade blur-bg" id="send-invoice-sidebar" aria-hidden="true">
          <div class="modal-dialog sidebar-lg">
            <div class="modal-content p-0 glass-morphi-border bg-glass-morphi ">
        ...
        <!-- Add Payment Sidebar -->
        <div class="modal modal-slide-in fade blur-bg" id="add-payment-sidebar" aria-hidden="true">
          <div class="modal-dialog sidebar-lg">
            <div class="modal-content p-0 bg-glass-morphi glass-morphi-border">
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                <Icon name="material-symbols:close" size="25" />
              </button>
              <div class="modal-header mb-1">
                <h5 class="modal-title">
                  <span class="align-middle text-white">Add Payment</span>
                </h5>
              </div>
              <div class="modal-body flex-grow-1">
                <form>
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select bg-transparent text-white" id="payment-method">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control bg-transparent text-white" id="payment-note" rows="5" placeholder="Internal Payment Note"></textarea>
                  </div>
